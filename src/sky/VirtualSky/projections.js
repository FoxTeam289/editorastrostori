...
const gal2radec = (l, b) => {
  ...
  return Transform(
    [l, b],
    [
      -0.054875539726, 0.494109453312, -0.867666135858, -0.87343710801, -0.444829589425, -0.198076386122, -0.483834985808, 0.74698225181,
      0.455983795705,
    ],
    false
  );
...
export const stereo = {
  azel2xy: function (az, el, w, h) {
    var a = w / 2; // Половина ширины
    var b = h / 2; // Половина высоты

    // Простое преобразование азимута и угла возвышения в x и y
    var x = a + a * Math.cos(el) * Math.sin(az);
    var y = b - b * Math.cos(el) * Math.cos(az);
  ...
  xy2azel: function (x, y, w, h) {
    ...
    // Простое обратное преобразование x и y в азимут и угол возвышения
    var X = (x - a) / a;
    var Y = (b - y) / b;

    var el = Math.acos(Math.sqrt(X * X + Y * Y));
...
export const fk1tofk5 = (a, b) => {
  ...
  return Transform(
    [a, b],
    [
      0.9995358730015703, -0.02793693620138929, -0.012147682028606801, 0.027936935758478665, 0.9996096732234282, -0.00016976035344812515,
